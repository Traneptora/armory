---
layout: post
title: "Stonemaker War Pick"
date: 2026-07-26
sources: [BMT.68]
tags: [very-rare, weapon, attunement]
subtags: [weapon: martial, weapon: melee]
---
***Martial melee weapon (war pick), very rare (requires attunement)***

You gain a +1 bonus to attack and damage rolls made with this magic war pick. It has the following special properties:

**Meld into Stone.** You can cast the *[Meld into Stone](https://grimoire.thebombzen.xyz/spells/meld-into-stone)* spell from this war pick. Once this property is used, it can’t be used again until the next dawn.
