...
***Esoteric Knowledge.*** While the device is floating, you can use an action to cast *[legend lore](https://grimoire.thebombzen.xyz/spells/legend-lore)* from the device. The device speaks the revealed lore aloud. Once this property has been used, it can’t be used again until the next dawn.
