...
date: 2026-07-11
sources: [GGR.181]
tags: [very-rare, staff, weapon, attunement]
subtags: [weapon: simple, weapon: melee, attunement: spellcaster]
---
...
This staff has 10 charges. While holding it, you can use an action to expend 1 or more of the staff's charges to cast one of the following spells from it, using your spell save DC: *[banishment](https://grimoire.thebombzen.xyz/spells/banishment)* (4 charges), *[blink](https://grimoire.thebombzen.xyz/spells/blink)* (3 charges), *[misty step](https://grimoire.thebombzen.xyz/spells/misty-step)* (2 charges), *[passwall](https://grimoire.thebombzen.xyz/spells/passwall)* (5 charges), or *[teleport](https://grimoire.thebombzen.xyz/spells/teleport)* (7 charges).
