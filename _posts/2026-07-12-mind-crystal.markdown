...
date: 2026-07-12
sources: [PBTSO.218]
tags: [common, uncommon, rare, wondrous-item, consummable]
---
...
When you cast a spell that has a casting time of 1 action while holding a *mind crystal,* you can modify the spell in a speciifc way that has an effect described below. You can use only a single *mind crystal* to modify the spell, and you can’t use a *mind crystal* and a Metamagic option on the same spell. Once you use a *mind crystal,* it becomes a nonmagical gem worth 50 gp.
...
***Heightened (Rare).*** Choose one creature affected by the spell. That creature has diadvantage on the first saving throw it makes against the spell.
